...
class Property(TimeStampedUUIDModel):
    ...
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=180, default="140"
    )
    street_address = models.CharField(
        verbose_name=_("Street Addres"), max_length=150, default="KG8 Avenue"
    )
    property_number = models.IntegerField(
        verbose_name=_("Propert Number"), validators=[MinValueValidator(1)], default=112
    )
    ...
    cover_photo = models.ImageField(
        verbose_name=_("Main Photo"), default="/house_sample.png", null=True, blank=True
    )
    photo1 = models.ImageField(
        verbose_name=_("Photo 1"), default="/house_sample.png", null=True, blank=True
    )
    photo2 = models.ImageField(
        verbose_name=_("Photo 2"), default="/house_sample.png", null=True, blank=True
    )
    photo3 = models.ImageField(
        verbose_name=_("Photo 3"), default="/house_sample.png", null=True, blank=True
    )
    photo4 = models.ImageField(
        verbose_name=_("Photo 4"), default="/house_sample.png", null=True, blank=True
    )
