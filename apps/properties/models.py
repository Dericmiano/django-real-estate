...
class Property(TimeStampedUUIDModel):
    ...
    street_address = models.CharField(verbose_name=_("Street Addres"),
                                      max_length=150, default="KG8 Avenue")
    property_number = models.IntegerField(verbose_name=_("Propert Number"),
    ...
    advert_type = models.CharField(
        verbose_name=_("Advert Type"), max_length=50, choices=AdvertType.choices,
        default=AdvertType.FOR_SALE
    )
    property_type = models.CharField(
        verbose_name=_("Property Type"), max_length=50, choices=PropertyType.choices,
        default=PropertyType.OTHER
    )
    cover_photo = models.ImageField(
        verbose_name=_("Main Photo"),
        default="/house_sample.png", null=True, blank=True
    )
    ...
    views = models.IntegerField(
        verbose_name=_("Total Views"), default=0
    )
