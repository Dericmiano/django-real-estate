# Generated by Django 3.2.7 on 2023-09-01 02:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='KE', verbose_name='Description')),
                ...
                ('postal_code', models.CharField(default='140', max_length=180, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='KG8 Avenue', max_length=150, verbose_name='Street Addres')),
                ('property_number', models.IntegerField(default=112, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Propert Number')),
                ...
                ('cover_photo', models.ImageField(blank=True, default='/house_sample.png', null=True, upload_to='', verbose_name='Main Photo')),
                ('photo1', models.ImageField(blank=True, default='/house_sample.png', null=True, upload_to='', verbose_name='Photo 1')),
                ('photo2', models.ImageField(blank=True, default='/house_sample.png', null=True, upload_to='', verbose_name='Photo 2')),
                ('photo3', models.ImageField(blank=True, default='/house_sample.png', null=True, upload_to='', verbose_name='Photo 3')),
                ('photo4', models.ImageField(blank=True, default='/house_sample.png', null=True, upload_to='', verbose_name='Photo 4')),
