...
class ProfileFactory(factory.django.DjangoModelFactory):
    ...
    gender = factory.LazyAttribute(lambda x: f"other") # noqa
    ...
    num_reviews = factory.LazyAttribute(lambda x: faker.random_int(min=0, max=5))
...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    email = factory.LazyAttribute(lambda x: f"deri@gmail.com") # noqa
